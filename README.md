...
A modelagem relacional foi enxugada para remover a maior parte das colunas `system` e equivalentes das tabelas finais, reduzindo largura, ruído e redundância sem perder os campos analiticamente úteis.
