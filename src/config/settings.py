...
class ProjectSettings:
    ...
    medication: ResourceIngestionSettings
    ...
    medication_statement_ed: ResourceIngestionSettings
...
def load_project_settings() -> ProjectSettings:
    ...
    medication_yaml = load_yaml_file(root / "config/ingestion/medication.yaml")
    ...
    observation_datetimeevents_yaml = load_yaml_file(
    ...
    medication_statement_ed_yaml = load_yaml_file(root / "config/ingestion/medication_statement_ed.yaml")
    ...
    encounter_ed = _load_resource_settings(
        encounter_ed_yaml,
    ...
    medication = _load_resource_settings(
        medication_yaml,
        source=root / "config/ingestion/medication.yaml",
        root=root,
    )
    medication_mix = _load_resource_settings(
        medication_mix_yaml,
        source=root / "config/ingestion/medication_mix.yaml",
        root=root,
    )
    medication_request = _load_resource_settings(
        medication_request_yaml,
        source=root / "config/ingestion/medication_request.yaml",
        root=root,
    )
    specimen = _load_resource_settings(
        specimen_yaml,
    ...
    condition_ed = _load_resource_settings(
        condition_ed_yaml,
    ...
    procedure_ed = _load_resource_settings(
        procedure_ed_yaml,
    ...
    observation_labevents = _load_resource_settings(
        observation_labevents_yaml,
    ...
    observation_micro_org = _load_resource_settings(
        observation_micro_org_yaml,
        source=root / "config/ingestion/observation_micro_org.yaml",
        root=root,
    )
    observation_micro_susc = _load_resource_settings(
        observation_micro_susc_yaml,
    ...
    observation_datetimeevents = _load_resource_settings(
        observation_datetimeevents_yaml,
        source=root / "config/ingestion/observation_datetimeevents.yaml",
        root=root,
    )
    observation_outputevents = _load_resource_settings(
        observation_outputevents_yaml,
    ...
    medication_dispense = _load_resource_settings(
        medication_dispense_yaml,
    ...
    medication_administration = _load_resource_settings(
        medication_administration_yaml,
    ...
    medication_statement_ed = _load_resource_settings(
        medication_statement_ed_yaml,
        source=root / "config/ingestion/medication_statement_ed.yaml",
        root=root,
    )
