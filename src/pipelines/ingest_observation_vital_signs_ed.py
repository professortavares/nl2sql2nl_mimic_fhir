"""
Pipeline de ingestão do recurso FHIR ObservationVitalSignsED.
"""
...
class ObservationVitalSignsEDIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de ObservationVitalSignsED.
    """

    def __init__(self, settings: ProjectSettings, loader: ObservationVitalSignsEDLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.observation_vital_signs_ed
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = ObservationVitalSignsEDTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "ObservationVitalSignsED"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de ObservationVitalSignsED usando uma conexão já aberta.
        """
