"""
Pipeline de ingestão do recurso FHIR MedicationDispenseED.
"""
...
class MedicationDispenseEDIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de MedicationDispenseED.
    """

    def __init__(self, settings: ProjectSettings, loader: MedicationDispenseEDLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.medication_dispense_ed
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = MedicationDispenseEDTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "MedicationDispenseED"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de MedicationDispenseED usando uma conexão já aberta.
        """
