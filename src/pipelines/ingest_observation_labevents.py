"""
Pipeline de ingestão do recurso FHIR ObservationLabevents.
"""
...
class ObservationLabeventsIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de ObservationLabevents.
    """

    def __init__(self, settings: ProjectSettings, loader: ObservationLabeventsLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.observation_labevents
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = ObservationLabeventsTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "ObservationLabevents"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de ObservationLabevents usando uma conexão já aberta.
        """
