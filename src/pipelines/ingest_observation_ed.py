"""
Pipeline de ingestão do recurso FHIR ObservationED.
"""
...
class ObservationEDIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de ObservationED.
    """

    def __init__(self, settings: ProjectSettings, loader: ObservationEDLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.observation_ed
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = ObservationEDTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "ObservationED"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de ObservationED usando uma conexão já aberta.
        """
