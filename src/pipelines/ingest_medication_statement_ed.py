"""
Pipeline de ingestão do recurso FHIR MedicationStatementED.
"""
...
class MedicationStatementEDIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de MedicationStatementED.
    """

    def __init__(self, settings: ProjectSettings, loader: MedicationStatementEDLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.medication_statement_ed
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = MedicationStatementEDTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "MedicationStatementED"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de MedicationStatementED usando uma conexão já aberta.
        """
