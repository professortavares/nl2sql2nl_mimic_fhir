"""
Pipeline de ingestão do recurso FHIR MedicationMix.
"""
...
class MedicationMixIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de MedicationMix.
    """

    def __init__(self, settings: ProjectSettings, loader: MedicationMixLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.medication_mix
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = MedicationMixTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "MedicationMix"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de MedicationMix usando uma conexão já aberta.
        """
