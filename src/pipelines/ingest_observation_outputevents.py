"""
Pipeline de ingestão do recurso FHIR ObservationOutputevents.
"""
...
class ObservationOutputeventsIngestionPipeline:
    """
    Coordena leitura, transformação e persistência de ObservationOutputevents.
    """

    def __init__(self, settings: ProjectSettings, loader: ObservationOutputeventsLoader) -> None:
        """
        Inicializa o pipeline.
        """

        self._settings = settings.observation_outputevents
        self._common_settings = settings.common
        self._loader = loader
        self._reader = NdjsonGzipReader(self._settings.input_path)
        self._transformer = ObservationOutputeventsTransformer()
    ...
    def resource_name(self) -> str:
        ...
        return "ObservationOutputevents"

    def ingest(self, connection: Connection) -> ResourceIngestionSummary:
        """
        Executa a ingestão de ObservationOutputevents usando uma conexão já aberta.
        """
