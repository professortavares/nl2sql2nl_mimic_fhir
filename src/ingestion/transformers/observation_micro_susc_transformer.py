...
class ObservationMicroSuscTransformer:
    ...
    def transform(self, resource: Mapping[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "antibiotic_code_system": self._extract_coding_value(resource.get("code"), "system"),
            ...
            "interpretation_system": self._extract_interpretation_value(resource.get("valueCodeableConcept"), "system"),
