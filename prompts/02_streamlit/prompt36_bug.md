...
1. Tabela: condition_ed
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_ed

2. Tabela: medication_dispense_ed
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_ed

3. Tabela: medication_statement_ed
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_ed

4. Tabela: observation_ed
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_ed

5. Tabela: observation_ed
   - Coluna: procedure_id
   - Hoje referencia incorretamente: procedure
   - Deve referenciar: procedure_ed

6. Tabela: observation_vital_signs_ed
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_ed

7. Tabela: observation_vital_signs_ed
   - Coluna: procedure_id
   - Hoje referencia incorretamente: procedure
   - Deve referenciar: procedure_ed

8. Tabela: procedure_icu
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_icu

9. Tabela: medication_administration_icu
   - Coluna: encounter_id
   - Hoje referencia incorretamente: encounter
   - Deve referenciar: encounter_icu
...
- `procedure_icu.encounter_id` é resolvido a partir de `encounter_icu`.
