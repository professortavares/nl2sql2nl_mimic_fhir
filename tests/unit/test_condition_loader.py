"""
Testes do carregador de Condition.
"""
...
def test_insert_batch_nullifies_orphan_patient_and_encounter_references(caplog) -> None:
    ...
    loader = ConditionLoader(
        tables=ConditionTables(condition=condition_table),
    ...
    batch = [
        {"id": "cond-1", "patient_id": "pat-ok", "encounter_id": "enc-ok"},
        {"id": "cond-2", "patient_id": "pat-missing", "encounter_id": "enc-ok"},
        {"id": "cond-3", "patient_id": "pat-ok", "encounter_id": "enc-missing"},
        {"id": "cond-4", "patient_id": "pat-missing", "encounter_id": "enc-missing"},
    ]
    ...
    assert inserted_rows == [
        {"id": "cond-1", "patient_id": "pat-ok", "encounter_id": "enc-ok"},
        {"id": "cond-2", "patient_id": None, "encounter_id": "enc-ok"},
        {"id": "cond-3", "patient_id": "pat-ok", "encounter_id": None},
        {"id": "cond-4", "patient_id": None, "encounter_id": None},
    ]
